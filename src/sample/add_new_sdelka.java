...
public class add_new_sdelka implements Initializable {
    ...
    @FXML
    private ComboBox<String> name_inventar;

    @FXML
    private ComboBox<String> fio_sotrud;

    @FXML
    private ComboBox<String> fio_visitor;

    @FXML
    private Label itog_cost;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ObservableList<String> fio_visit = FXCollections.observableArrayList();
        fio_visit.addAll("1", "2", "3");
        fio_visitor.setItems(fio_visit);

        ObservableList<String> fio_sotr = FXCollections.observableArrayList();
        fio_sotr.addAll("1", "2", "3");
        fio_sotrud.setItems(fio_sotr);

        ObservableList<String> inventar = FXCollections.observableArrayList();
        inventar.addAll("1", "2", "3");
        name_inventar.setItems(inventar);
    }
